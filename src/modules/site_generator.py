...
# Import Lucide icon maps (markers, map UI, and dashboard icons)
try:
    from .lucide_markers import LUCIDE_MARKER_BASE64_MAP, MAP_ICONS_MAP, DASHBOARD_ICONS_MAP
except ImportError:
...
(function() {
    ...
    def generate_minimal_lucide_js(self) -> str:
        ...
        in the application. Icons are sourced from MAP_ICONS_MAP and 
        DASHBOARD_ICONS_MAP in lucide_markers.py.
        ...
        """
        # Combine map and dashboard icons for frontend use
        all_icons = {**MAP_ICONS_MAP, **DASHBOARD_ICONS_MAP}
        
        # Convert Python dict to JSON-safe JavaScript object
        icons_json = json.dumps(all_icons, indent=2)
        
        # Generate minimal createIcons implementation
        lucide_js = f'''
// Minimal Lucide Icons - Only {len(all_icons)} icons used by this app
// Full library would be ~531KB, this is ~3KB
// Generated by site_generator.py from lucide_markers (MAP_ICONS_MAP + DASHBOARD_ICONS_MAP)
(function() {{
    "use strict";
...
// Dashboard & Map UI icons (Lucide SVG for speech bubbles, controls, debug UI)
window.DASHBOARD_ICONS = {json.dumps(all_ui_icons, ensure_ascii=False)};'''
